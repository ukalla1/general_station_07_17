...
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/design_1.protoinst" -protoinst "protoinst_files/test_design_bd.protoinst" -protoinst "protoinst_files/test_clk_m.protoinst" -protoinst "protoinst_files/test_clk_s.protoinst" -log simulate.log
}
