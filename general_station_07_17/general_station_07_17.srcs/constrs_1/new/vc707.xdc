...
set_property IOSTANDARD LVCMOS18 [get_ports CLK_VERIF_OUT]
...
## LEDs
###LED index 0
#set_property PACKAGE_PIN AM39 [get_ports tmp_trigger]                 
#set_property IOSTANDARD LVCMOS18 [get_ports tmp_trigger]
###########################
...
#set_property PACKAGE_PIN BA31 [get_ports trigger_master]
#set_property IOSTANDARD LVCMOS18 [get_ports trigger_master]
#set_property PACKAGE_PIN BA32 [get_ports GPIO_DIP_SW3]
#set_property IOSTANDARD LVCMOS18 [get_ports GPIO_DIP_SW3]
#set_property PACKAGE_PIN AW30 [get_ports uart_on]
#set_property IOSTANDARD LVCMOS18 [get_ports uart_on]
...
set_property IOSTANDARD LVCMOS18 [get_ports rst_clk_en]
...
set_property IOSTANDARD LVCMOS18 [get_ports tx_serial_out]            
#####GPIO_N
set_property PACKAGE_PIN AP31 [get_ports rx_serial_in]               
set_property IOSTANDARD LVCMOS18 [get_ports rx_serial_in]            
...
set_property IOSTANDARD LVCMOS18 [get_ports uart_serial_out]
#set_property PACKAGE_PIN AT32 [get_ports USB_UART_RTS]
#set_property IOSTANDARD LVCMOS18 [get_ports USB_UART_RTS]
#set_property PACKAGE_PIN AU33 [get_ports uart_serial_out]
#set_property IOSTANDARD LVCMOS18 [get_ports uart_serial_out]
